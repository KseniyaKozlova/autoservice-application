...
class TransportComparatorTest {
    ...
    void compareTest_successful() {
        ...
        final TransportComparator comparator = new TransportComparator(sortingRequirements);
        final int expected = comparator.compare(transport1, transport2);
