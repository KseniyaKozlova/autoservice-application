...
public enum Category {
    ...
    private static final Map<String, Category> CATEGORY_MAP = Arrays.stream(Category.values())
            .collect(Collectors.toMap(translation -> translation.title, category -> category));
    private final String title;
    private final Integer cost;


    Category(String title, Integer cost) {
        this.title = title;
        this.cost = cost;
    }
    ...
    public static Category getCategoryByTitle(final String name) throws CategoryException {
        ...
        if (category != null) {
            ...
            throw new CategoryException("File contains nonexistent category");
        }
    }
}
